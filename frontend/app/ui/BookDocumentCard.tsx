...
export default function BookDocumentCard(document: BookDocumentCardProps) {
	...
	return (
		<div className="h-full w-full border border-border-300 hover:border-border-200 group relative flex cursor-pointer flex-col gap-1.5 rounded-xl py-5 px-6 transition-all ease-in-out hover:shadow-sm active:scale-[0.98] md:gap-4">
